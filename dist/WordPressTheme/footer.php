          ...
          <div class="contact__container">
            ...
            <div class="contact__message">
              <div class="contact__title">
                <h2 class="contact__engtitle">お問い合わせ</h2>
          ...
          <div class="grobal-nav__container">
            <ul class="grobal-nav__items">
              <li class="grobal-nav__item">
                ...
                <a href="./info.html#tab_panel-2">貸切体験ダイビング</a>
                <a href="./info.html#tab_panel-3">ナイトダイビング</a>
              </li>
              <li class="grobal-nav__item">
                <a href="./about-us-us.html">私たちについて</a>
              </li>
            </ul>
            <ul class="grobal-nav__items">
              <li class="grobal-nav__item">
          ...
          <div class="grobal-nav__container">
            <ul class="grobal-nav__items">
              ...
              <li class="grobal-nav__item">
                ...
                <a href="./price.html#price-1">ライセンス講習</a>
                <a href="./price.html#price-2">体験ダイビング</a>
                <a href="./price.html#price-3">ファンダイビング</a>
              </li>
            </ul>
            <ul class="grobal-nav__items">
              <li class="grobal-nav__item">
